...
variable "subscription_id" {
  description = "(Required) Specifies the Azure Subscription ID for deployments."
  type        = string
  nullable    = false
}
...
variable "aks_kubernetes_version" {
  description = "(Required) The Kubernetes version for the AKS cluster. Defaults to `1.34`. More info: https://learn.microsoft.com/en-us/azure/aks/supported-kubernetes-versions?wt.mc_id=MVP_348953"
  type        = string
  nullable    = false
  default     = "1.34"
}
...
variable "nvidia_device_plugin_image_tag" {
  description = "(Required) The image tag for the NVIDIA Device Plugin. Defaults to `v0.18.0`. More info: https://github.com/NVIDIA/k8s-device-plugin"
  type        = string
  nullable    = false
  default     = "v0.18.0"
}
...
variable "nvidia_device_plugin_chart_version" {
  description = "(Required) The Helm chart version for the NVIDIA Device Plugin. Defaults to `v0.18.0`. More info: https://github.com/NVIDIA/k8s-device-plugin"
  type        = string
  nullable    = false
  default     = "v0.18.0"
}
...
variable "ollama_image_tag" {
  description = "(Required) The Docker image tag for the Ollama service. Defaults to `0.12.1`. More info: https://hub.docker.com/r/ollama/ollama/tags"
  type        = string
  nullable    = false
  default     = "0.12.1"
}
...
variable "ollama_chart_version" {
  description = "(Required) The community Helm Chart version for the Ollama service. Defaults to `1.34.0`. More info: https://github.com/otwld/ollama-helm"
  type        = string
  nullable    = false
  default     = "1.34.0"
}
